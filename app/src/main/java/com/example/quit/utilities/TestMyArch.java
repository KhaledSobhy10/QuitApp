...
public class TestMyArch extends View {
    private Paint paint;
    ...
    public TestMyArch(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TestMyArch(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        default_text_size = Utils.sp2px(getResources(), 18);
        min_size = (int) Utils.dp2px(getResources(), 100);
        default_text_size = Utils.sp2px(getResources(), 40);
        default_suffix_text_size = Utils.sp2px(getResources(), 14);
        default_suffix_text = "%";
    ...
    public TestMyArch(Context context) {
        super(context);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        String text = decimalFormat.format(getProgress());
        if (!TextUtils.isEmpty(text)) {
            ...
            canvas.drawText(suffixText, getWidth() / 2.0f  + textPaint.measureText(text) , textBaseline + textHeight - suffixHeight, textPaint);
        }
